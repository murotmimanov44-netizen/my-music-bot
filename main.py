...
SESSION = "СИЗДИН_STRING_SESSION" # Бул жерге аккаунттун сессиясын коюңуз

# Клиенттерди ишке киргизүү
...
async def play_video(client, message):
    ...
    # YouTube издөө жөндөөлөрү (480p - серверге күч келтирбейт)
